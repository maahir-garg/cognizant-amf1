...
- 2026-09-24 | Integrated Singapore Street Circuit SVG vector visualizer, pit-wall LED RPM gauges, Recharts sensitivity curve, and live paddock telemetry ribbon | Upgrades UI from generic dark-mode template to authentic Aston Martin Aramco F1 mission control aesthetic, rendering circuit coordinates and real-time telemetry deltas without relying on proprietary logos.
